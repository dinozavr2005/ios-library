...
## пример таблицы для [статьи](https://habr.com/ru/post/724376/)
...
// Strings, Integers, Floating point numbers и Booleans
// все хашбл по дефолту.
...
// Остаток от деления
let even = 2 % 2
let odd = 3 % 2 // остаток 1
let initialSize = 16
let index = hashCode % initialSize // гарантируем что поместится
